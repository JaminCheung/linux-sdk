...
struct authentication_result {
    void (*construct)(struct authentication_result* this,
            struct fingerprint* fp, int user_id);
    void (*destruct)(struct authentication_result* this);

    struct fingerprint* (*get_fingerprint)(struct authentication_result* this);
    int (*get_user_id)(struct authentication_result* this);
